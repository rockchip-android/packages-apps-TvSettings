...
public class BluetoothDevicePairer {
    ...
    private void openConnection() {
        ...
        if (btConnector != null) {
            ...
            // With some input deive, device is already connected when reach here.
            // So will not do connect in HidService, as log like:
            //   HidService(  609): Hid Device not disconnected: 00:1F:20:F0:22:54
            // This will cause mStatus can't switch from STATUS_CONNECTING to STATUS_NONE.
            // Final cause connect fail.
            // Add connect check here (delay 3s) to avoid this problem.
